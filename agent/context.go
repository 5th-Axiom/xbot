...
func BuildMessages(history []llm.ChatMessage, userContent string, channel string, memory *MemoryStore, memoryDir string, workDir string, dataDir string, skillsPrompt string) []llm.ChatMessage {
